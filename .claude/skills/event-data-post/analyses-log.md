...
**Status:** `Posted` = live on X · `Ready` = report + image + thread done (queue/draft it) · `Backlog` = angle found, not built · `Paused` = started, blocked.
...
| 2026-06-07 | The 1954 World Cup averaged **5.4 goals/game**; the last five ~2.5 — a 70-yr slide that flatlined in the '90s | FIFA World Cup 2026 | Fjelstul World Cup DB — goals/game per men's tournament, 1930–2022 | chartsage.app/report/0755fecf5ab2440c8d8f9ab840d658db — UTM `worldcup`/`goals-per-game` | `#WorldCup2026` | **Ready** |
| 2026-06-07 | The shootout hierarchy: Argentina **6–1** (most of anyone); Germany & Croatia perfect; England's curse = 1 in 4 | FIFA World Cup 2026 | Fjelstul World Cup DB — penalty-shootout W/L by nation, since 1982 | chartsage.app/report/03f80df2faf4402c9a24e182541dfb35 — UTM `worldcup`/`shootouts` | `#WorldCup2026` | **Ready** |
