...
| 2026-06-07 | The WC got mean, then mellowed — cards/game tripled from 1.6 (1970) to a **5.2 peak in 2006**, cooled to ~3.5; reds 0 → 0.44 → 0.06 | FIFA World Cup 2026 | Fjelstul World Cup DB — bookings/game per men's tournament, 1970–2022 | _CSV + thread + self-QA'd hero ready; awaiting brand-account run_ | `#WorldCup2026` | **Ready** |
