...
export const PRICING = {
  ...
  blurbP: 'Reports and extra charts run on credits, so you only pay for what you make. Your first report is free; when you need more, top-up packs start at $5.',
  rows: [
    ...
    { k: 'Top-up packs', v: '$5 / $15 / $40', muted: false },
  ],
};
...
export const FAQ = [
  ...
  { q: 'How do credits work?', a: `Your first report is free with no account. A new account starts with ${SIGNUP_GRANT} credits; a report costs ${REPORT_COST} and generating five more charts costs ${GENERATE_MORE_COST}. When you run low, top-up packs start at $5.` },
